...
## Report bugs using Github's [issues](https://github.com/BMTLab/each/issues)

We use GitHub issues to track public bugs. Report a bug
by [opening a new issue](https://github.com/BMTLab/each/issues/new); it's that easy!
...
Thank you for contributing to the **BMTLab/each** project!
